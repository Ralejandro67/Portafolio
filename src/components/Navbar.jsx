...
const Navbar = () => {
  ...
  return (
    <header className="header">
        ...
        <nav className="flex text-lg gap-7 font-medium max-sm:text-[1rem]">
            ...
            <NavLink to="/contact" className={({ isActive }) => isActive ? 'text-teal max-sm:hidden' : 'text-black max-sm:hidden'}>{t('contact')}</NavLink>
            <button
